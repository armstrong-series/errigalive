                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 20px;font-family:'Montserrat',sans-serif;"
                                                            align="left">
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('erilive.png') }}"
                                                                            alt="Logo" title="Logo"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 134px;"
                                                                            width="134" />
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('transaction-mail/images/image-6.jpeg') }}"
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align"
                                                                style="margin: 0px; color: #555555; line-height: 140%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: 'Montserrat',sans-serif; font-size: 20px;">
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <em><span
                                                                            style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;">Thank
                                                                            you for complete your process to
                                                                            <strong>Eriggalive</strong> event concert
                                                                        </span></em></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <em><span
                                                                            style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;">Below
                                                                            is your transaction details</span></em></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h4 class="v-text-align"
                                                                style="margin: 0px; color: #720c10; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: arial,helvetica,sans-serif; font-size: 15px;">
                                        ...
                                        <div
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        ...
                                                                        Inquiries and future event contact <span
                                                                            style="color: #c02a2b; font-size: 14px; line-height: 19.6px;">
                                                                            <span
                                                                                style="text-decoration: underline; font-size: 14px; line-height: 19.6px;">support@eriggalive</span>.</span></span>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <em><span
                                                                            style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;">Thank
                                                                            you for your attention to this matter and
                                                                            your continued business.</span></em></p>
                                                            </div>
                                            ...
                                            <table style="font-family:'Montserrat',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 30px 20px;font-family:'Montserrat',sans-serif;"
                                                            align="left">
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 12px; line-height: 16.8px;">&copy;Company
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        ...
                                                                        ipsum, or lipsum as it is sometimes known, is
                                                                        dummy</span></p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 12px; line-height: 16.8px;">
                                                                        text used in laying out print </span></p>
                                                            </div>
