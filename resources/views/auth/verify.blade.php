...
<head>
    ...
    <title>Eriggalive | Email Verification</title>
                                                ...
                                                <td align="center"
                                                    ...
                                                    <div style="line-height: 22px;">
                                                        <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                                                            @csrf
                                                             <button type="submit" class="btn btn-md" style="color: #ffffff; ">Verify your Account</button>
                                                        </form>
                                            ...
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    <div
                                                        ...
                                                        Email us: <br /> <a href="#"
                                                            style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">support@eriggalive.com</a>
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <div style="line-height: 24px;">
                                            ...
                                            <span style="color: #333333;">EriggaLive</span>
